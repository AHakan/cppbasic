...
// Farklı veri türüne sahip benzer fonksiyonları ya da benzer sınıfları
// oluşturmak için kullanılır. Şablon oluşturarak kod kalabalıklığını ortadan
// kaldırır.

// Fonksiyon şeklinde tanım
template <class T> T topla(T deger1, T deger2) { return deger1 + deger2; }

// Class şeklinde tanım
template <class C> class Sayi {
public:
  C sayi1, sayi2;
  Sayi(C d1, C d2) {
    this->sayi1 = d1;
...
template <class C> C Sayi<C>::topla() { return this->sayi1 + this->sayi2; }
